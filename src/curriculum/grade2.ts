...
export const grade2: GradeDef = {
  ...
  strands: [
    ...
    },
    {
      ...
      name: "Geometry",
      topics: [
        { name: "2D Shapes", family: "shapes-2d", params: { maxStage: 2 } },
        { name: "3D Shapes", family: "shapes-3d", params: {} },
        { name: "Sides", family: "shapes-2d", params: { maxStage: 2 } },
        { name: "Vertices", family: "shapes-2d", params: { maxStage: 2 } },
        { name: "Partitioning Shapes", family: "shapes-2d", params: { maxStage: 2 } },
      ],
    },
    {
      id: "stats",
      name: "Data",
      topics: [
        { name: "Picture Graphs", family: "read-graph", params: { type: "picture", maxStage: 3 } },
        { name: "Bar Graphs", family: "read-graph", params: { type: "bar", maxStage: 3 } },
